...
public class AdminController {
    ...
    @GetMapping("/lots")
    public ResponseEntity<org.springframework.data.domain.Page<unipi.lsmdb.SPFS.DTO.ParkingLotResponseDTO>> getAllParkingLots(
        ...
        org.springframework.data.domain.Page<unipi.lsmdb.SPFS.DTO.ParkingLotResponseDTO> lotsWithLiveStatus = adminService
